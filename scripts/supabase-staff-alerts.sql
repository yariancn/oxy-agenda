...
COMMENT ON COLUMN company_config.staff_alert_first_sessions_only IS 'Si true, alertas de cita nueva solo para primeras sesiones (paciente nuevo o primera visita en la clínica).';
