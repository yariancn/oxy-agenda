...
Importante:
• Paciente nuevo: teléfono de 10 dígitos.
• Si el nombre ya existe, no escribas a mano: elige de la lista.
• No se puede crear una cita nueva en el pasado.
• Puedes marcar repetición en varias fechas al agendar.`,
...
• You cannot create a brand-new appointment in the past.
• You can set multi-date repeat when booking.`,
  },
  {
    id: 'reschedule_move',
