...
No se puede crear una cita nueva en un día anterior (hoy sí, aunque la hora ya haya pasado). Para mover a un día anterior usa código 0000.`,
...
You cannot create a brand-new appointment on a previous day (today is allowed even for earlier hours). Moving to a previous day uses code 0000.`,
  },
  {
    id: 'reschedule_move',
...
Mover a un día anterior:
• Al elegir un día previo aparece el código de autorización.
• Ingresa 0000 → autorizar → confirmar.
• Hoy (aunque la hora ya haya pasado) no pide código: puedes crear y mover libremente.`,
...
Moving to a previous day:
• Choosing a prior day opens the authorization code modal.
• Enter 0000 → authorize → confirm.
• Today (even earlier hours) needs no code — you can create and move freely.`,
  },
  {
    id: 'search_patient',
