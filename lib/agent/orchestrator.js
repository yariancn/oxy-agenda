...
import { buildAdminDesignAlert, shouldNotifyMasterOnSession } from './adminNotify.js';
...
export async function handleAgentMessage({
  ...
  const adminAlert = shouldNotifyMasterOnSession(ctx)
    ? buildAdminDesignAlert(audit, { locale })
    : { shouldNotify: false };
  ...
  if (!intent.toolId) {
    ...
    return agentResponse({
      ...
      adminAlert: adminAlert.shouldNotify ? adminAlert : undefined,
