...
export const INSTALL_DISMISS_KEY = 'oxy-install-guide-dismissed-v3';
      ...
      steps: [
        {
          id: 'menu',
          title: 'Paso 1: Menú ⋮',
          body: 'Toca los tres puntitos arriba a la derecha en Chrome.',
          mockup: 'chrome-menu',
          autoLabel: null,
          autoAction: null,
        },
        {
          id: 'share',
          title: 'Paso 2: Compartir',
          body: 'En el menú elige «Compartir…» o el ícono de compartir.',
          mockup: 'chrome-share',
          autoLabel: 'Abrir Compartir por mí',
          autoAction: 'web-share',
        },
        {
          id: 'add-home',
          title: 'Paso 3: Agregar a Inicio',
          body: 'Desliza la fila de iconos y toca «Agregar a Inicio» (ícono + dentro de un cuadrado).',
          mockup: 'share-sheet-add',
          autoLabel: null,
          autoAction: null,
        },
        {
          ...
          body: 'Arriba a la derecha toca «Agregar». ¡Listo! Busca OXY Agenda en tu pantalla de inicio.',
          mockup: 'confirm-add',
          autoLabel: null,
          autoAction: null,
        },
    ...
    steps: [
      {
        ...
        body: ctx.isIPad
          ? 'Arriba a la derecha toca el cuadrado con flecha hacia arriba (Compartir).'
          : 'Abajo en el centro toca el cuadrado con flecha hacia arriba (Compartir).',
      ...
      },
      {
        ...
        body: 'En el menú que se abrió, baja un poco y toca «Agregar a Inicio» (+ en un cuadrado).',
        mockup: 'share-sheet-add',
        autoLabel: null,
        autoAction: null,
      },
      {
        ...
        body: 'Toca «Agregar» arriba a la derecha. OXY Agenda quedará en tu pantalla de inicio.',
        mockup: 'confirm-add',
        autoLabel: null,
        autoAction: null,
      },
