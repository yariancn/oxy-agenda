...
/** Online cancel request — stays on calendar until staff approves. */
export const CANCEL_REQUEST_STATUS = 'Pendiente cancelación';
...
export function isCancelRequestPending(status) {
  return String(status || '') === CANCEL_REQUEST_STATUS;
}
