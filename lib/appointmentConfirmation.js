...
export async function sendConfirmationSmsForAppointment({
  ...
  // SMS already left Twilio — always persist by id. Older rows may have NULL
  // instead of 'none'; filtering on status alone could match 0 rows and leave
  // the chart stuck on "Not sent yet" while the UI showed success.
