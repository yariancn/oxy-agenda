 ...
 *    - always on tab focus / visible again
 */
export function useAgendaLiveSync({
  ...
  useEffect(() => {
    ...
    const scheduleFallback = () => {
      clearFallback();
      let delay = fallbackIntervalMs;
      if (document.visibilityState === 'hidden') {
        delay = hiddenFallbackIntervalMs;
      } else if (realtimeOkRef.current) {
        delay = healthyFallbackIntervalMs;
      }
