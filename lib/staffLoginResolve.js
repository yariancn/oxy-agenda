import { ALL_CLINICS, gdlStaffClinicAccess, CLINIC_SHENANDOAH } from './clinicRegistry.js';
...
function buildUserFromStaff(gdlStaff, txStaff) {
...
export async function resolveStaffLoginWithCredentials({
  ...
  const user = buildUserFromStaff(gdlOk ? gdlStaff : null, txOk ? txStaff : null);
