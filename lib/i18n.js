...
const ALERTS = {
  es: {
    ...
    undoNoShowConfirm: '¿Revertir NO ASISTIÓ? La cita vuelve a Agendado y se deshace el descuento (adeudo -1 o +1 sesión a cartera).',
    undoNoShowOk: 'No-show revertido. Puedes marcar Llegó / En sesión.',
  ...
  en: {
    ...
    undoNoShowConfirm: 'Undo NO-SHOW? Appointment returns to Scheduled and the charge is reversed (debt -1 or +1 session to wallet).',
    undoNoShowOk: 'No-show undone. You can mark Arrived / In session.',
