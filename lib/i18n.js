...
export function buildCalendarWeek(locale, currentDate, clinic = 'Guadalajara') {
...
const STAFF = {
  es: {
    ...
    weekFilterHint: 'Vista semana con varios equipos: filtra uno para ver más detalle.',
    weekFilterApply: 'Filtrar 1.er equipo',
    weekFilterDismiss: 'Entendido',
  ...
  en: {
    ...
    weekFilterHint: 'Week view with multiple rooms: filter one for more detail.',
    weekFilterApply: 'Filter 1st room',
    weekFilterDismiss: 'Got it',
...
const ALERTS = {
  es: {
    ...
    noShowConfirm: 'Marcar NO ASISTIÓ: se descontará 1 sesión pagada de la cartera. ¿Continuar?',
  ...
  en: {
    ...
    genericError: (m) => `Error: ${m}`,
    noShowConfirm: 'Mark NO-SHOW: 1 paid session will be deducted from the wallet. Continue?',
