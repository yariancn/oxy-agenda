...
const ALERTS = {
  es: {
    ...
    pastMoveCodePrompt: 'Vas a mover la cita a un horario o fecha ya pasada.\nIngresa el código de autorización (0000):',
    pastMoveCodeTitle: 'Autorizar movimiento al pasado',
    pastMoveCodeLabel: 'Código (0000)',
    pastMoveCodeConfirm: 'Autorizar y continuar',
    pastMoveCodeWrong: 'Código incorrecto. No se movió la cita al pasado.',
    pastMoveOverrideHint: 'Autorizado con código — destino en el pasado',
    ...
    pastMoveClickHint: 'Para mover al pasado: Reprogramar → elige el horario → código 0000.',
  ...
  en: {
    ...
    pastMoveCodePrompt: 'You are moving this appointment to a past date or time.\nEnter the authorization code (0000):',
    pastMoveCodeTitle: 'Authorize past move',
    pastMoveCodeLabel: 'Code (0000)',
    pastMoveCodeConfirm: 'Authorize and continue',
    pastMoveCodeWrong: 'Incorrect code. The appointment was not moved to the past.',
    pastMoveOverrideHint: 'Authorized with code — destination is in the past',
    ...
    pastMoveClickHint: 'To move into the past: Reschedule → pick the time → code 0000.',
