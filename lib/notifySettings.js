...
export function resolveSessionInstructions(
  ...
  // Las notas de primera sesión solo se envían cuando el paciente es nuevo
  // (para la clínica o para ese tratamiento/equipo). El resto de mensajes
  // (programación, reprogramación, cancelación) no llevan notas.
